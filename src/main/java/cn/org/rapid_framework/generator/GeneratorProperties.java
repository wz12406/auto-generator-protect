...
import cn.org.rapid_framework.generator.main.AutoGeneratorMain;
...
public class GeneratorProperties {
	protected static final Logger  logger = LoggerFactory.getLogger(GeneratorProperties.class);  
	...
	public static void reload() {
		try {
			...
			p.load(new FileInputStream(new File("conf/generator.properties")));
